...
```
47b6357	open	-	bug	Migrate auth tables
2e285eb	open	-	epic	Epic: backend rewrite
```
...
```
3d1b6b7	open	-	feature	Rewrite /login handler
2e285eb	open	-	epic	Epic: backend rewrite
```
...
1245ac9	open	-	feature	Write the README
86417df	open	-	epic	Epic: ship v1
f42490c	open	-	bug	Backend handler crashes on empty input
a4025c4	open	-	roadmap	Roadmap: demo project
